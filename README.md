# Moodle Plugins Fetcher Plugin [![Build Status](https://travis-ci.org/adpe/moodle-local_pluginsfetcher.svg?branch=MOODLE_38_STABLE)](https://travis-ci.org/adpe/moodle-local_pluginsfetcher)
